...
def commercialApproval(request, approval_type, lead_id, approvalStatus):
    ...
    if service_category_instance != None:
        if approvalStatus == 'approved':
            ...
            message = f'<h2>Hello {service_category_instance.associate.name if service_category_instance.associate else ''},</h2></br><p>Commercial has been approved for lead id {service_category_instance.lead_id}. <a href="http://10.20.52.37:3000/lead_management">Click here to proceed further</a>.</p>'
